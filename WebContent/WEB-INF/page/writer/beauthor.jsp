                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="beauthor" method="post">
                                    <div class="control-group">
                                        <label class="control-label" for="basicinput">手机号</label>
                                        <div class="controls">
                                            <input  type="text" name="phone" placeholder="输入手机号"  class="span8 tip">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="basicinput">银行卡号</label>
                                        <div class="controls">
                                            <input  type="text" placeholder="输入银行卡号"  class="span8 tip" name="bankCard">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <div class="controls">
