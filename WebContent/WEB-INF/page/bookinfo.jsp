                        ...
                        <div class="module-body">
                            <div class="profile-head media">
                                <a href="#" class=" pull-left">
                                    <img src="${bookinfo.bookPic}" style="width:100px;height:150px;">
                                </a>
                                <div class="media-body">
                                    <h4>
                                        ${bookinfo.bookName }<small>${bookinfo.authorName }</small><small>${bookinfo.category }</small>
                                    </h4>
                                    <p class="profile-brief">
                                 		 ${bookinfo.bookBrief }
                                    </p>
                                    <div class="profile-details muted">
                                        <a href="javascript:void(0)" onclick="bookshelf(${bookinfo.id})" class="btn"><i class="icon-plus shaded"></i>加入书架 </a>
                                    </div>
                                </div>
                            </div>
                            <ul class="profile-tab nav nav-tabs">
                                <li class="active"><a href="#activity" data-toggle="tab">目录</a></li>
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <c:forEach items="${bookcatalog.selectresult}" var="c">
					            	<tr><a href="../chapter/${c.id}" style="display:block;">${c.chapterName }</a></tr>
					            </c:forEach>                                  
                                </table>
                            </div>
                        </div>
