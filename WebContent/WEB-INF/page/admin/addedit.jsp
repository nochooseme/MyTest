    ...
    <div class="navbar-inner">
        <div class="container">
            <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                <i class="icon-reorder shaded"></i></a><a class="brand" href="index.html">书阅 </a>
            ...
            <div class="span3">
                <div class="sidebar">
                    <ul class="widget widget-menu unstyled">
                        <li class="active"><a href="edit" style="background-color:white;">编辑管理
                        </a></li>
                        <li  ><a href="searchAuthor">用户管理</a>
                        </li>
                    ...
                    <div class="module message">
                        ...
                        <div class="module-option clearfix">
                           <div class="pull-left">
                                ...
                                <div>
                                        ...
                                        <input type="text" class="span3" name="param" value="${param.param }" id="param">
                        ...
                        <div class="module-body table">
                            ...
                            <table class="table table-message">
                                ...
                                <c:forEach items="${result.selectresult}" var="u">
	                                <tr class="task">
	                                    ...
	                                    <td class="cell-time align-right"><a href="addEdit/?id=${u.id}">添加</a></td>
	                                </tr>
								</c:forEach>
                                </tbody>
                            </table>
