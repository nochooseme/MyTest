        ...
        <div class="main">
            ...
            <form action="../updatechapter" method="post">
	            <div>
	                ...
	                <input class="writechaptername" type="text" name="chapterName" placeholder="章节名" value="${result.chapterName }">
	                <textarea class="writecontent" name="content" placeholder="正文" >${result.content }</textarea>
	            </div>
